...
MATCH
	(person:Person {given: "Ellen", surname: "Currano"}),
	(public:Group {name: "public"}),
	(schema:Schema {title: "Cornell MLA"})<-[:CHARACTER_OF]-(leafAttachment:Character {name: "Leaf Attachment"}),
	...
	//(:Schema {title: "Cornell MLA"})<-[:CHARACTER_OF]-(laminaAttachment:Character {name: "Position of Lamina Attachment"}),
	//	(laminaAttachment)<-[:STATE_OF]-(laminaAttachment_marginal:State {name: "marginal"}),
	//(:Schema {title: "Cornell MLA"})<-[:CHARACTER_OF]-(petioleBase:Character {name: "Petiole Base"}),
	...
	(schema)<-[:CHARACTER_OF]-(baseShape:Character {name: "Base Shape"}),
		(baseShape)<-[:STATE_OF]-(State {name: "there is no basal extension (lb = 0)"})<-[:STATE_OF]-(baseShape_convex:State {name: "convex"}),
...
CREATE
    ...
    (description)-[:ELEMENT_OF]->(public),
		...
		(characterInstance02)-[:ELEMENT_OF]->(public),
		...
		(characterInstance03a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance03b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance03c)-[:ELEMENT_OF]->(public),
		...
		(characterInstance04a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance04b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance05a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance05b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance06)-[:ELEMENT_OF]->(public),
		...
		(characterInstance09)-[:ELEMENT_OF]->(public),
		...
		(characterInstance10)-[:ELEMENT_OF]->(public),
		...
		(characterInstance11)-[:ELEMENT_OF]->(public),
		...
		(characterInstance12)-[:ELEMENT_OF]->(public),
		...
		(characterInstance13a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance13b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance14)-[:ELEMENT_OF]->(public),
		...
		(characterInstance15)-[:ELEMENT_OF]->(public),
...
MATCH
	(person:Person {given: "Ellen", surname: "Currano"}),
    (public:Group {name: "public"}),
	(schema:Schema {title: "Cornell MLA"})<-[:CHARACTER_OF]-(laminarSize:Character {name: "Laminar Size"}),
		(laminarSize)<-[:STATE_OF]-(laminarSize_microphyll:State {name: "microphyll"}),
	(schema)<-[:CHARACTER_OF]-(laminarShape:Character {name: "Laminar Shape"}),
		(laminarShape)<-[:STATE_OF]-(laminarShape_ovate:State {name: "ovate"}),
		(laminarShape)<-[:STATE_OF]-(laminarShape_oblong:State {name: "oblong"}),
	...
	(schema)<-[:CHARACTER_OF]-(baseShape:Character {name: "Base Shape"}),
		(baseShape)<-[:STATE_OF]-(:State {name: "there is no basal extension (lb = 0)"})<-[:STATE_OF]-(:State {name: "convex"})<-[:STATE_OF]-(baseShape_rounded:State {name: "rounded"}),
		(baseShape)<-[:STATE_OF]-(:State {name: "there is a basal extension (lb > 0)"})<-[:STATE_OF]-(baseShape_cordate:State {name: "cordate"}),
	(schema)<-[:CHARACTER_OF]-(baseAngle:Character {name: "Base Angle"}),
		(baseAngle)<-[:STATE_OF]-(baseAngle_obtuse:State {name: "obtuse"}),
	(schema)<-[:CHARACTER_OF]-(apexShape:Character {name: "Apex Shape"}),
		(apexShape)<-[:STATE_OF]-(apexShape_acuminate:State {name: "acuminate"}),
...
CREATE
    ...
    (description)-[:ELEMENT_OF]->(public),
		...
		(characterInstance02a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance02b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance04)-[:ELEMENT_OF]->(public),
		...
		(characterInstance05)-[:ELEMENT_OF]->(public),
		...
		(characterInstance6)-[:ELEMENT_OF]->(public),
		...
		(characterInstance7)-[:ELEMENT_OF]->(public),
		...
		(characterInstance8a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance8b)-[:ELEMENT_OF]->(public),
		...
		(characterInstance9)-[:ELEMENT_OF]->(public),
...
CREATE
    ...
    (description)-[:ELEMENT_OF]->(public),
		...
		(characterInstance07:CharacterInstance {pbotID: apoc.create.uuid()}),
		(characterInstance07)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		(characterInstance07)-[:ELEMENT_OF]->(public),
		(description)-[:DEFINED_BY]->(characterInstance07),
		...
		(characterInstance08a)-[:ELEMENT_OF]->(public),
		...
		(characterInstance08b)-[:ELEMENT_OF]->(public),
