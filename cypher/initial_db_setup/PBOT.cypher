...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "distal flank", definition: "curvature of the distal flank relative to the middline of the tooth"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state111:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state11),
				(state111)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state112:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state11),
				(state112)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state113:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state11),
				(state113)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state114:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state11),
				(state114)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state115:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state11),
				(state115)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "proximal flank", definition: "curvature of the proximal flank relative to the middline of the tooth"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state121:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state12),
				(state121)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state122:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state12),
				(state122)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state123:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state12),
				(state123)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state124:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state12),
				(state124)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state125:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state12),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state21:State {stateID: apoc.create.uuid(), name: "distal flank", definition: "curvature of the distal flank relative to the middline of the tooth"})-[:STATE_OF]->(state2),
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state211:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state21),
				(state211)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state212:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state21),
				(state212)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state213:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state21),
				(state213)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state214:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state21),
				(state214)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state215:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state21),
				(state215)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state22:State {stateID: apoc.create.uuid(), name: "proximal flank", definition: "curvature of the proximal flank relative to the middline of the tooth"})-[:STATE_OF]->(state2),
			(state22)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "distal flank", definition: "curvature of the distal flank relative to the middline of the tooth"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state311:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state31),
				(state311)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state312:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state31),
				(state312)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state313:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state31),
				(state313)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state314:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state31),
				(state314)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state315:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state31),
				(state315)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state32:State {stateID: apoc.create.uuid(), name: "proximal flank", definition: "curvature of the proximal flank relative to the middline of the tooth"})-[:STATE_OF]->(state3),
			(state32)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state321:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state32),
				(state321)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state322:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state32),
				(state322)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state323:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state32),
				(state323)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state324:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state32),
				(state324)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state325:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state32),
		...
		(state4)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state41:State {stateID: apoc.create.uuid(), name: "distal flank", definition: "curvature of the distal flank relative to the middline of the tooth"})-[:STATE_OF]->(state4),
			(state41)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state411:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state41),
				(state411)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state412:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state41),
				(state412)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state413:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state41),
				(state413)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state414:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state41),
				(state414)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state415:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state41),
				(state415)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state42:State {stateID: apoc.create.uuid(), name: "proximal flank", definition: "curvature of the proximal flank relative to the middline of the tooth"})-[:STATE_OF]->(state4),
			(state42)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state421:State {stateID: apoc.create.uuid(), name: "cv", definition: "convex"})-[:STATE_OF]->(state42),
				(state421)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state422:State {stateID: apoc.create.uuid(), name: "st", definition: "straight"})-[:STATE_OF]->(state42),
				(state422)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state423:State {stateID: apoc.create.uuid(), name: "cc", definition: "concave"})-[:STATE_OF]->(state42),
				(state423)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state424:State {stateID: apoc.create.uuid(), name: "fl", definition: "flexuous such that tooth flank is apically concave and basally convex"})-[:STATE_OF]->(state42),
				(state424)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state425:State {stateID: apoc.create.uuid(), name: "rt", definition: "retroflexed such that tooth flank is basally concave and apically convex"})-[:STATE_OF]->(state42),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "looped", definition: "with multiple looping connections to principal vein"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),	
			(state31:State {stateID: apoc.create.uuid(), name: "spinose", definition: "principal vein extends beyond the leaf margin; extension may be short or long, usually sharp"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state32:State {stateID: apoc.create.uuid(), name: "mucronate", definition: "an opaque, vascularized, peg-shaped, non-deciduous projection is present at the apex"})-[:STATE_OF]->(state3),
			(state32)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state33:State {stateID: apoc.create.uuid(), name: "setaceous", definition: "an opaque, peg-shaped, deciduous projection is present at the apex"})-[:STATE_OF]->(state3),
			(state33)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state34:State {stateID: apoc.create.uuid(), name: "papillate", definition: "a clear, flame-shaped projection is present at the apex"})-[:STATE_OF]->(state3),
			(state34)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state35:State {stateID: apoc.create.uuid(), name: "spherulate", definition: "a clear, spherical projection is present at the apex"})-[:STATE_OF]->(state3),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			...
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state211:State {stateID: apoc.create.uuid(), name: "basal", definition: "primary veins radiate from the petiolar insertion point"})-[:STATE_OF]->(state21),
				(state211)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state212:State {stateID: apoc.create.uuid(), name: "suprabasal", definition: "primary veins radiate from a point distal to petiolar insertion"})-[:STATE_OF]->(state21),
				(state212)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			...
			(state23)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state231:State {stateID: apoc.create.uuid(), name: "basal", definition: "primary veins radiate from the petiolar insertion point"})-[:STATE_OF]->(state23),
				(state231)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state232:State {stateID: apoc.create.uuid(), name: "suprabasal", definition: "primary veins radiate from a point distal to petiolar insertion"})-[:STATE_OF]->(state23),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "craspedodromous", definition: "secondaries terminate at the margin or at the marginal vein"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "semicraspedodromous (usually in toothed leaves)", definition: "secondaries branch near the margin; one of the branches terminates at the margin and the other joins the superjacent secondary"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state13:State {stateID: apoc.create.uuid(), name: "festooned semicraspedodromous", definition: "secondaries form more than one set of loops, with branches from the most exmedial loops terminating at the margin"})-[:STATE_OF]->(state1),
			(state13)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			...
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state211:State {stateID: apoc.create.uuid(), name: "basal eucamptodromous", definition: "all eucamptodromous secondaries arise from the base of the leaf, within 0.25L from base of leaf"})-[:STATE_OF]->(state21),
				(state211)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state212:State {stateID: apoc.create.uuid(), name: "hemieucamptodromous", definition: "all eucamptodromous secondaries arise from the proximal half of the leaf, with 0.5L from base of leaf"})-[:STATE_OF]->(state21),
				(state212)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state213:State {stateID: apoc.create.uuid(), name: "eucamptodromous becoming brochidodromous distally", definition: "proximal secondaries are eucamptodromous, but distal secondaries form loops of secondary guage"})-[:STATE_OF]->(state21),
				(state213)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "simple brochidodromous", definition: "secondaries join in a series of proinent arhes or loops of seconary gauge, and junctions between secondaries are excurrent and the smaller vein has >25% of the gauge of the larger vein at the junction"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state32:State {stateID: apoc.create.uuid(), name: "festooned brochidodromous", definition: "secondaries branch into multiple sets of loops of secondary gauge, often with accessory loops of higher gauge"})-[:STATE_OF]->(state3),
			(state32)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "parallel to major secondaries"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "perpendicular to midvein"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "reticulating or ramifying", definition: "branching and losing a defined course"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state32:State {stateID: apoc.create.uuid(), name: "parallel to a major secondary"})-[:STATE_OF]->(state3),
			(state32)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state33:State {stateID: apoc.create.uuid(), name: "perpendicular to a subjacent major secondary"})-[:STATE_OF]->(state3),
			(state33)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state34:State {stateID: apoc.create.uuid(), name: "basiflexed but not joining the subjacent secondary at right angles", definition: "uPDATE"})-[:STATE_OF]->(state3),
			(state34)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state4)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state41:State {stateID: apoc.create.uuid(), name: "less than one per intercostal area"})-[:STATE_OF]->(state4),
			(state41)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state42:State {stateID: apoc.create.uuid(), name: "usually one per intercostal area"})-[:STATE_OF]->(state4),
			(state42)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state43:State {stateID: apoc.create.uuid(), name: "more than one per intercostl area"})-[:STATE_OF]->(state4),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "course of percurrent tertiaries"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state111:State {stateID: apoc.create.uuid(), name: "opposite", definition: "majority of tertiaries cross betwen adjacent secondaries in parallel paths without branching"})-[:STATE_OF]->(state11),
				(state111)-[:ENTERED_BY {timestamp: datetime()}]->(person),
					(state1111:State {stateID: apoc.create.uuid(), name: "straight", definition: "passing across the intercostal area without a noticeable change in course"})-[:STATE_OF]->(state111),
					(state1111)-[:ENTERED_BY {timestamp: datetime()}]->(person)
					(state1112:State {stateID: apoc.create.uuid(), name: "convex", definition: "middle portion of the vein arches exmedially, without an inflection point"})-[:STATE_OF]->(state111),
					(state1112)-[:ENTERED_BY {timestamp: datetime()}]->(person)
					(state1113:State {stateID: apoc.create.uuid(), name: "sinuous", definition: "changes direction of curvature"})-[:STATE_OF]->(state111),
					(state1113)-[:ENTERED_BY {timestamp: datetime()}]->(person)
					(state1114:State {stateID: apoc.create.uuid(), name: "forming a chevron", definition: "most tertiary courses have a markedly sharp bend"})-[:STATE_OF]->(state111),
					(state1114)-[:ENTERED_BY {timestamp: datetime()}]->(person)
				(state112:State {stateID: apoc.create.uuid(), name: "alternate", definition: "majority of tertiaries cross between secondaries with regular offsets (abrupt angular dicontinuities) near the middle of the intercostal area"})-[:STATE_OF]->(state11),
				(state112)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state113:State {stateID: apoc.create.uuid(), name: "mixed", definition: "tertiaries have both opposite and alternate pecurrent courses"})-[:STATE_OF]->(state11),
				(state113)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "angle of percurrent tertiaries", definition: "angle formed between the midvein trend and the course of a percurrent 3° vein projected to the midvein"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state121:State {stateID: apoc.create.uuid(), name: "acute", definition: "angle >0° and <90°"})-[:STATE_OF]->(state12),
				(state121)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state122:State {stateID: apoc.create.uuid(), name: "obtuse", definition: "angle >90° and <180°"})-[:STATE_OF]->(state12),
				(state122)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state123:State {stateID: apoc.create.uuid(), name: "perpendicular", definition: "angle is ~90°"})-[:STATE_OF]->(state12),
				(state123)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "admedially ramified", definition: "multiple tertiary veins branch toward the primary or midvein"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state32:State {stateID: apoc.create.uuid(), name: "exmedially ramified", definition: "tertiary branching is oriented toward the leaf margin"})-[:STATE_OF]->(state3),
			(state32)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state33:State {stateID: apoc.create.uuid(), name: "transversly ramified", definition: "opposed 3° veins from adjacent major secondaries ramify and join at a higher vein order"})-[:STATE_OF]->(state3),
			(state33)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state34:State {stateID: apoc.create.uuid(), name: "transversly freely ramified", definition: "tertiary veins originating on one secondary vein branch toward adjacent secondary but do not join other veins from the opposing secondary"})-[:STATE_OF]->(state3),
			(state34)-[:ENTERED_BY {timestamp: datetime()}]->(person);
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "basally concentric", definition: "special case of "increasing exmedially" such that the tertiaries form a "spider web pattern" around the primary vein(s) at the base of the leaf"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "percurrent", definition: "epimedial veins cross between 1° and 2° veins"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state111:State {stateID: apoc.create.uuid(), name: "opposite percurrent", definition: "majority of tertiaries cross between primary and secondaries in parallel paths without branching"})-[:STATE_OF]->(state11),
				(state111)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state112:State {stateID: apoc.create.uuid(), name: "alternate percurrent", definition: "majority of tertiaries cross between primary and secondaries with regular offsets (abrupt angular dicontinuities)"})-[:STATE_OF]->(state11),
				(state112)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state113:State {stateID: apoc.create.uuid(), name: "mixed", definition: "approximately equal number of opposite and alternate percurrent tertiaries"})-[:STATE_OF]->(state11),
				(state113)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "ramified", definition: "epimedial tertiaries branch toward the leaf margin"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state13:State {stateID: apoc.create.uuid(), name: "reticulate", definition: "epimedial tertiaries anastomose with other 3° veins to form a net"})-[:STATE_OF]->(state1),
			(state13)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state14:State {stateID: apoc.create.uuid(), name: "mixed", definition: "epimedial tertiaries do not consistently exhibit one characteristic"})-[:STATE_OF]->(state1),
			(state14)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		(state2:State {stateID: apoc.create.uuid(), name: "course of percurrent epimedial tertiaries"})-[:STATE_OF]->(character),
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state21:State {stateID: apoc.create.uuid(), name: "proximal/admedial course of the epimedial tertiaries", definition: "course of the epimedial tertiaries from the junction with the midvein to their approximate midpoint, more than one character state may apply"})-[:STATE_OF]->(state2),
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state211:State {stateID: apoc.create.uuid(), name: "parallel to the subjacent secondary"})-[:STATE_OF]->(state21),
				(state211)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state212:State {stateID: apoc.create.uuid(), name: "parallel to the intercostal tertiaries"})-[:STATE_OF]->(state21),
				(state212)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state213:State {stateID: apoc.create.uuid(), name: "perpendicular to the midvein"})-[:STATE_OF]->(state21),
				(state213)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state214:State {stateID: apoc.create.uuid(), name: "parallel to the intersecondary"})-[:STATE_OF]->(state21),
				(state214)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state215:State {stateID: apoc.create.uuid(), name: "obtuse to the midvein"})-[:STATE_OF]->(state21),
				(state215)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state216:State {stateID: apoc.create.uuid(), name: "acute to the midvein"})-[:STATE_OF]->(state21),
				(state216)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state22:State {stateID: apoc.create.uuid(), name: "distal/exmedial course of the epimedial tertiaries", definition: "course of the epimedial tertiaries from their approximate midpoint to their intersection with the adjacent secondary (if not ramifying or reticulating), more than one character state may apply"})-[:STATE_OF]->(state2),
			(state22)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "opposite", definition: "most quaternary veins cross between adjacent tertiary veins in parallel paths without branching"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "alternte", definition: "most quaternary veins cross between adjacent tertiaries with an offset (an abrupt angular discontinuity)"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state13:State {stateID: apoc.create.uuid(), name: "mixed percurrent", definition: "quaternaries are alternate and opposite in equal proportions"})-[:STATE_OF]->(state1),
			(state13)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state21:State {stateID: apoc.create.uuid(), name: "regular", definition: "angles formed by the vein intersections are regular"})-[:STATE_OF]->(state2),
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state22:State {stateID: apoc.create.uuid(), name: "irregular", definition: "angles formed by the vein intersections are highly variable"})-[:STATE_OF]->(state2),
			(state22)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "regular", definition: "angles formed by the vein intersections are regular"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "irregular", definition: "angles formed by the vein intersections are highly variable"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state21:State {stateID: apoc.create.uuid(), name: "poor development", definition: "areoles many-sided (often >7) and of highly irregular size and shape"})-[:STATE_OF]->(state2),
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state22:State {stateID: apoc.create.uuid(), name: "moderate development", definition: "areoles of irregular shape, more or less variable in size, generally with <7 sides"})-[:STATE_OF]->(state2),
			(state22)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state23:State {stateID: apoc.create.uuid(), name: "good development", definition: "areoles of relatively consistent size and shape and generally with 3-6 sides"})-[:STATE_OF]->(state2),
			(state23)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state24:State {stateID: apoc.create.uuid(), name: "paxillate", definition: "areoles occurring in distinct oriented fields"})-[:STATE_OF]->(state2),
			(state24)-[:ENTERED_BY {timestamp: datetime()}]->(person);
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state1)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state11:State {stateID: apoc.create.uuid(), name: "FEVs absent"})-[:STATE_OF]->(state1),
			(state11)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state12:State {stateID: apoc.create.uuid(), name: "mostly unbranched", definition: "FEVs present but unbranched, may be straight or curved"})-[:STATE_OF]->(state1),
			(state12)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state13:State {stateID: apoc.create.uuid(), name: "mostly with one branch"})-[:STATE_OF]->(state1),
			(state13)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state14:State {stateID: apoc.create.uuid(), name: "mostly with two or more branches"})-[:STATE_OF]->(state1),
			(state14)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state141:State {stateID: apoc.create.uuid(), name: "branching equal (dichotomous)"})-[:STATE_OF]->(state14),
				(state141)-[:ENTERED_BY {timestamp: datetime()}]->(person),
				(state142:State {stateID: apoc.create.uuid(), name: "branching unequal (dendritic)"})-[:STATE_OF]->(state14),
				(state142)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		(state2:State {stateID: apoc.create.uuid(), name: "FEV terminals"})-[:STATE_OF]->(character),
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state21:State {stateID: apoc.create.uuid(), name: "simple"})-[:STATE_OF]->(state2),
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state22:State {stateID: apoc.create.uuid(), name: "tracheoid idioblasts", definition: "FEV endings are club-shaped and consist of tracheal cells with spiral wall thickenings"})-[:STATE_OF]->(state2),
			(state22)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state23:State {stateID: apoc.create.uuid(), name: "highly branched sclerids", definition: "FEVs branch densely (10+) out of the plane of the veins; the finer branches often stain differently because they are sclerids, not tracheids"})-[:STATE_OF]->(state2),
			(state23)-[:ENTERED_BY {timestamp: datetime()}]->(person);
...
CREATE
    ...
    (character)-[:ENTERED_BY {timestamp: datetime()}]->(person),
		...
		(state2)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			...
			(state21)-[:ENTERED_BY {timestamp: datetime()}]->(person);	
		(state3:State {stateID: apoc.create.uuid(), name: "basil extension length", definition: "lb"})-[:STATE_OF]->(character),
		(state3)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "quantity"})-[:STATE_OF]->(state3),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person);
		(state4:State {stateID: apoc.create.uuid(), name: "midvein length", definition: "lm"})-[:STATE_OF]->(character),
		(state4)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state41:State {stateID: apoc.create.uuid(), name: "quantity"})-[:STATE_OF]->(state4),
			(state41)-[:ENTERED_BY {timestamp: datetime()}]->(person);
		(state5:State {stateID: apoc.create.uuid(), name: "width ratio", definition: "the ratio of the smaller to the larger of the two distances measured perpendicularly from the midvein to the margin on each side of the leaf at the position of maximum leaf width; on a lobed leaf, the width ratio is measured to the outermost portion of the leaf"})-[:STATE_OF]->(character),
		(state5)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state51:State {stateID: apoc.create.uuid(), name: "quantity"})-[:STATE_OF]->(state5),
			(state51)-[:ENTERED_BY {timestamp: datetime()}]->(person);
		(state6:State {stateID: apoc.create.uuid(), name: "basil width ratio", definition: "similar to width ratio but meausred only in the widest portion of the base of the leaf (0.25 lm base"})-[:STATE_OF]->(character),
		(state6)-[:ENTERED_BY {timestamp: datetime()}]->(person),
			(state31:State {stateID: apoc.create.uuid(), name: "quantity"})-[:STATE_OF]->(state6),
			(state31)-[:ENTERED_BY {timestamp: datetime()}]->(person);
